...
function validarpromo(idpromo) {
  var param1=MetodoEnum.Validar_Fecha;
  var dataString = 'param1=' + param1+ '&idpromo=' + idpromo;
  $.ajax({
    type    : 'POST',
    url     : 'respuesta.php',
    data    :  dataString,
...
function ctaCoupon(idpromo,promo_imgcupon,idproveedor,test){
  showLoadCoupon();
  setTimeout(function(){
