  ...
  <body id="plantillaUno" class="fontArial blancoTx" style="background-image:url('ui/img/back/pepsi.jpg')">
    ...
    <section id="homeUno" class="trans5 displayNone">
      <div class="wrapSuperior displayFlex">
        <img id="productoImg" src="ui/img/producto/pepsi.png">
        <div class="productoInfo">
          <div class="infoTitle">
            <img id="textoInicioImg" src="ui/img/textoInicio/default.png">
          </div>
          <div class="prize">
            <img id="prizeImg" src="ui/img/precio/default.png">
          </div>
        </div>
      </div>
      <div class="wrapInferiorButton">
        <a role="button" onclick="ctaCoupon()">
          <img id="btCouponImg" class="trans5" src="ui/img/botonCupon/default.png">
        </a>
      </div>
    </section>
    <section id="cuponUno" class="trans5" style="display:none">
      <div class="wrapSuperior displayFlex">
        <img id="couponImg" src="ui/img/cupon/default.png">
      </div>
      <div class="wrapInferiorButton">
        <a role="button" onclick="ctaDownloadImg()">
          <img id="btCaptureScreen" class="trans5" src="ui/img/botonDescarga/default.png">
        </a>
      </div>
    </section>
    <section id="mensajeUno" class="trans5" style="display:none">
      ...
      <ul class="wrapSuperiorMensajeError" style="display:none">
        <li><img src="ui/img/mensajeError/default.png"></li>
      </ul>
      <div class="wrapInferiorSocial displayFlex">
        ...
        <a href="https://twitter.com/PepsiMEX" target="_blank"><img id="icInstagram" src="ui/img/ic/instagram.png" width="45" height="45"></a>
        <a href="https://www.instagram.com/pepsimex/" target="_blank"><img id="icTwitter" src="ui/img/ic/twitter.png" width="45" height="45"></a>
    ...
    <div id="prevent" class="displayNone" style="background-image:url('ui/img/back/pepsi.jpg')">
      <p></p>
    </div>
    <footer class="displayFlex">
      <p><a>Bases Términos y Condiciones</a></p>
      <span>|</span>
      <p id="footerPromoCopy">Este texto se puede modificar</p>
      <span>|</span>
