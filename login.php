        ...
        <div id="logHomeW">
          ...
          <form action="" method="">
            <div class="formDiv displayFlex">
              ...
              <input id="userNameLog" type="text"  name="" placeholder="Nombre de Usuario" required>
            </div>
            <div class="formDiv displayFlex">
              <span class="displayFlex">
              ...
              <input id="userPassLog" type="text" name="" placeholder="* * * * * *" required>
            </div>
            <a id="submitLogin" role="button" class="button login">Entrar</a>
